...
class ProfilingTools(object):
    """ Class to group tools for descriptive analysis"""
    ...
    def profile_dataframe(self, df):
        ...
        df_metrics["cardinality_perc"] = (
            df_metrics["count_unique"] / df_metrics["records"]
        )
        return df_metrics

    def add_percentile(self, df_in, col, col_group=None):
