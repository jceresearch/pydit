...
class ValidationTools(BaseTools):
    """ Class to group tools for validation and checks"""
    ...
    def check_duplicates(
        ...
        if output_file:
            ...
            file_tools._save_to_excel(df_ret, output_file, sheet_name="duplicates")
            # TODO: #19 Make it work with a public method.
